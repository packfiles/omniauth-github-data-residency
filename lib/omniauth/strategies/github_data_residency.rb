...
module OmniAuth
  module Strategies
    class GithubDataResidency < OmniAuth::Strategies::GitHub
      ...
      # Override the request_phase to build the client_options before calling super.
      # This is necessary to ensure that the correct client_options are used for the request.
      ...
      # Override the callback_phase to build the client_options before calling super.
      # This is necessary to ensure that the correct client_options are used for the callback request.
      ...
      # Raising an OAuth2::CallbackError will stop the callback_phase and it will prevent the redirect_uri from being set to an invalid url
      def build_client_options
        raise OmniAuth::Strategies::OAuth2::CallbackError.new("An Enterprise subdomain is required.") if invalid_enterprise_subdomain?
